...
public class EnemyManager : MonoBehaviour {
    ...
    private int greatestEnemySpawned = -1;
    ...
    public void SpawnEnemies(int round)
    {
        ...
        greatestEnemySpawned = numEnemyTypesToUse - 1;
    ...
    public int GetGreatestEnemyType()
    {
        return greatestEnemySpawned;
    }
    ...
    private void CalculateAndInstantiateMaxEnemiesInGame()
    {
        ...
        if (paths.Length == 0)
            throw new UnityException("No Paths to calculate distance from, add path script to paths");
