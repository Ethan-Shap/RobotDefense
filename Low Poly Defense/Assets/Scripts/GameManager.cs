...
public class GameManager : MonoBehaviour {
    ...
    private bool gameEnded = false; // TODO implmenet this
   ...
   private void Start()
    {
        ...
        //DataHelper.instance.ShowDataWithResponse("Tutorial?", (() => SceneManagement.LoadScene("Tutorial")), null);
    }
    ...
    public void Save()
    {
        ...
        if (sceneManagment.CurrentLevelNumber() > 0)
        {
            ...
            levelData = new LevelData(sceneManagment.CurrentLevelNumber(), towerPositions, enemyPositions, Round, enemyManager.SpawnRate.ToString(), player.Coins, player.Health);
        }
    ...
    public void LoadSaveData()
    {
        ...
        if(player.data.completedTutorial == 2)
        {
            DataHelper.instance.ShowDataWithResponse("", (() => sceneManagment.LoadScene("Tutorial")), null);
        }
    }

    public void PauseRound(bool openScreen)
    {
        enemyManager.Pause();
    ...
    {
        Round = 1;
        GPGamesManager.instance.UpdateAllAchievements();
    }
