...
public class PlayerData
{
    ...
    public int numOfTimesDied = 0;
    public int numTowersPlaced = 0;
    public int numNormalLevelsCompleted = 0;
    public int numHardLevelsCompleted = 0;
    public int completedTutorial = 0;
    ...
    public PlayerData()
    {
        ...
        this.numOfTimesDied = 0;
        this.numTowersPlaced = 0;
        this.numNormalLevelsCompleted = 0;
        this.numHardLevelsCompleted = 0;
    }

    public PlayerData(string playerName, int levelsUnlocked, int numberOfEnemiesKilled, int numberOfTimesDied, int towersPlaced, int numNormalLevelsCompleted, int numHardLevelsCompleted, int completedTutorial)
    {
        this.playerName = playerName;
        this.levelsUnlocked = levelsUnlocked;
        this.numEnemiesKilled = numberOfEnemiesKilled;
        this.numOfTimesDied = numberOfTimesDied;
        this.numTowersPlaced = towersPlaced;
        this.numNormalLevelsCompleted = numNormalLevelsCompleted;
        this.numHardLevelsCompleted = numHardLevelsCompleted;
